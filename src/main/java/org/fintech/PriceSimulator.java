...
public class PriceSimulator {
    ...
    public void executeTrade(double amountSC, boolean isBuy) {
        ...
        final double VOLATILITY_FACTOR_NEW = 0.1; // 💡 Beispielwert, bitte anpassen!
        // ----------------------------------------------

        // Maximale erlaubte Preisänderungen
        final double MAX_PRICE_DROP_PERCENT = 0.01; // Maximaler Drop: 1%
        final double MAX_PRICE_RISE_PERCENT = 0.02; // Maximaler Anstieg: 2% (Preis verdoppelt sich)
